    ...
    <header className="header">
      <div className="left-nav">
        <div className="header-left">
          ...
          <h6 className='all-font'>
            <span className="header-span">
              {path === '/department' ? 'All Departments Details information' : ''}
            </span>
          </h6>
          ...
          <h6 className='all-font'>
            <span className="header-span">
              {path === '/leaves' ? 'Leave Employee information' : ''}
            </span>
          </h6>
          <h3 className='all-font'>{path === '/setting' ? 'Setting ' : ''}</h3>
          <h6 className='all-font'>
            <span className="header-span">
              {path === '/setting' ? 'Setting Project Manager' : ''}
            </span>
          </h6>
          <h3 className='all-font'>{path === '/holiday' ? 'Holiday ' : ''}</h3>
          <h6 className='all-font'>
            <span className="header-span">{path === '/holiday' ? 'Holiday Day' : ''}</span>
          </h6>
        </div>
      </div>
